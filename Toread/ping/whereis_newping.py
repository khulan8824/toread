...
def pingNode(alive=0, timeout=2.0, ipv6=0, number=sys.maxint, node=None, \
...
if __name__ == '__main__':
    ...
    # default variables
    alive = 0; timeout = 2.0; ipv6 = 0; count = sys.maxint;
    flood = 0; size = ICMP_DATA_STR
    ...
    # here we send
    result = pingNode(alive=alive, timeout=timeout, ipv6=ipv6, number=count, \
